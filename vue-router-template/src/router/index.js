			...
			children: [{
				...
				},
				{
					...
					children: [{
							...
							path: '/lib_tiku',
							component: resolve => require(['../components/Libtiku.vue'], resolve),
							meta: {
								title: '题库'
							}
						},
						{
							...
							path: '/lib_ziyuanku',
							component: resolve => require(['../components/Libziyuanku.vue'], resolve),
							meta: {
								title: '资源库'
							}
						},
						{
							path: '/lib_huodongku',
							component: resolve => require(['../components/Libhuodongku.vue'], resolve),
							meta: {
								title: '活动库'
							}
						}
